        ...
        <div className="container mx-auto px-6 md:px-22 flex justify-between items-center overflow-visible">
          ...
          <div className="flex items-center space-x-3 text-stone-700">
            ...
            {user ? (
              ...
              <>
                {/* Mobile: compact icon-only sign-in */}
                <Link
                  to="/login"
                  className="md:hidden flex items-center justify-center w-8 h-8 text-[#1A1C19] hover:text-[#827668] transition-colors duration-300"
                  aria-label="Sign In"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <Link
                  to="/login"
                  className="hidden md:flex items-center text-[11px] font-semibold uppercase tracking-widest text-[#1A1C19] hover:text-[#827668] transition-colors duration-300 ml-1 py-1.5 px-6 border border-[#1A1C19] rounded-full hover:border-[#827668]"
                >
                  Sign In
                </Link>
              </>
